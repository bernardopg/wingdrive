...
Extensions in WingDrive are built with Rust macros that generate the integration code for you. Define your data models, jobs, and agents using attributes. The SDK handles sync, permissions, and sandboxing automatically.
...
```rust
#[extension(
    id = "com.wingdrive.photos",  // Unique reverse-DNS ID
    name = "Photos Manager",
    version = "1.0.0",
    description = "Advanced photo organization with faces and places.",
    min_core_version = "2.0.0",  // Minimum WingDrive core version
    permissions = [
...
- **Relationships**: You can define foreign key relationships to core WingDrive objects or other models in your extension.
