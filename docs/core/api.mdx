...
The API infrastructure provides a secure, unified entry point for all WingDrive operations. It handles authentication, authorization, session management, and request routing across CLI, Tauri desktop app, and native applications.
