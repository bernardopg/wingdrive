...
The `.tasks/` directory contains a structured task tracking system that manages the entire development lifecycle of WingDrive. Tasks are defined as markdown files with YAML frontmatter and validated against a JSON schema.
