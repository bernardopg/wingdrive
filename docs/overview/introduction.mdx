...
Read the [full release notes](https://github.com/bernardopg/wingdrive/releases) for more details on the rewrite.

</Callout>

## What is WingDrive?

WingDrive is a local-first file manager that unifies data across devices without centralized cloud services. Files stay where they are. WingDrive creates a content-aware index that makes them searchable, syncable, and manageable from anywhere.

<Frame>
  <img src="/public/SDColumnView.webp" alt="WingDrive column view file explorer" />
</Frame>

## Why WingDrive Exists
...
AI is accelerating this trend. Cloud services offer semantic search and intelligent analysis, but only if you upload your files to their infrastructure. WingDrive is building the architecture for local AI on hardware you already own, on data that never leaves your control.
...
WingDrive treats files as first-class objects with content identity. A photo on your laptop and the same photo on your NAS are recognized as one piece of content.
...
Files stay in place. WingDrive makes them universally addressable with rich metadata.
...
The `.tasks` folder in the repo tracks core development work. Check the [releases page](https://github.com/bernardopg/wingdrive/releases) for the public roadmap. These docs provide detailed technical reference.
...
WingDrive v2 development began in June 2025. This is a ground-up rewrite addressing lessons from the v1 alpha. The architecture is designed for long-term sustainability, not quick feature delivery.
...
- **Read the whitepaper** - [docs/overview/whitepaper.mdx](https://github.com/bernardopg/wingdrive/blob/main/docs/overview/whitepaper.mdx) (work in progress)
