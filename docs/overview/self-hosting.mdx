...
wget https://github.com/bernardopg/wingdrive/releases/latest/download/sd-server-linux-x86_64.tar.gz
...
ExecStart=/usr/local/bin/sd-server --data-dir /var/lib/wingdrive
Restart=on-failure
RestartSec=5s
