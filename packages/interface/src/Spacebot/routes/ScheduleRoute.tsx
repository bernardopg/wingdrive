const COLOR_GROUPS = [
	...
	},
	{
		...
		swatches: [
			...
			{name: 'app-dark-box', className: 'bg-app-dark-box'},
			{name: 'app-darker-box', className: 'bg-app-darker-box'},
			{name: 'app-light-box', className: 'bg-app-light-box'},
			...
			{name: 'app-selected-item', className: 'bg-app-selected-item'},
	...
	},
	{
		...
		swatches: [
			...
			{name: 'sidebar-ink-dull', className: 'bg-sidebar-ink-dull'},
			{name: 'sidebar-ink-faint', className: 'bg-sidebar-ink-faint'},
