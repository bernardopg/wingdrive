...
```bash
bun add @wingdrive/primitives @wingdrive/tokens
# or
npm install @wingdrive/primitives @wingdrive/tokens
```
...
1. **Configure your CSS entrypoint**
   ```css
   @import '@wingdrive/tokens/theme';
   ```

2. **Import CSS**
   ```css
   @import '@wingdrive/tokens/css';
   ```

## Usage

```tsx
import { Button, Card, Dialog, Input, Badge } from '@wingdrive/primitives';
...
```tsx
import { buttonVariants } from '@wingdrive/primitives';
