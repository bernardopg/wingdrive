...
```bash
bun add @wingdrive/tokens
# or
npm install @wingdrive/tokens
```
...
```typescript
import colors from '@wingdrive/tokens/raw-colors';
...
```css
@import '@wingdrive/tokens/css/themes/dark';
```

### Light Theme

```css
@import '@wingdrive/tokens/css/themes/light';
```
