...
fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	// Generate Swift API code automatically (Apple targets only)
...
///
/// Only Apple targets ship the Swift client, so running this on other
/// platforms would just emit a spurious build warning about a missing
/// packages/swift-client directory.
#[cfg(any(target_os = "macos", target_os = "ios"))]
