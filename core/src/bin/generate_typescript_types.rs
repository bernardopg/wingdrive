...
//! and generates comprehensive TypeScript types for the complete WingDrive API.
//!
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	typescript_code.push_str(
		"// Generated by WingDrive using Specta + rspc-inspired type extraction - DO NOT EDIT\n",
	);
	typescript_code.push_str(
