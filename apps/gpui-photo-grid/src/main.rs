...
fn main() {
	...
	let http_client = Arc::new(
		reqwest_client::ReqwestClient::user_agent("wingdrive-gpui")
			...
			cx.open_window(
				WindowOptions {
					...
					titlebar: Some(TitlebarOptions {
						title: Some("WingDrive Media Grid".into()),
				...
				|_, cx| {
					cx.new(|cx| {
						PhotoGridView::new(socket_addr, http_url, library_id, initial_path, cx)
					})
				},
			)
